...
import pyds
from utils.managers import EventManager
    ...
    while l_frame is not None:
        ...
        while l_obj is not None:
            try:
                ...
                break
            class_id, obj_label, object_id = obj_meta.class_id, obj_meta.obj_label, obj_meta.object_id
            ...
            try:
                ...
                break
        #*********** OBJECT METADATA END ******************
        frame = frame2image(gst_buffer, frame_meta)
        global event_manager
        detected_persons = event_manager.get_metadata(object_metadata_list)
        screenshots = event_manager.update(detected_persons, frame)
